...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col overflow-hidden rounded-none bg-card text-xs/relaxed text-card-foreground ring-1 ring-foreground/10 *:[img:first-child]:rounded-none *:[img:last-child]:rounded-none",
        className
      )}
      {...props}
    />
