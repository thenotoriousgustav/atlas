...
export const useBookmarksControllerTriggerHealthCheck = <TError = unknown,
 ...
 , queryClient?: QueryClient): UseMutationResult<
    ...
    /**
 * @summary Reorder bookmarks position
 */
export const bookmarksControllerReorder = (
    reorderBookmarksDto: ReorderBookmarksDto,
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
) => {


      return customInstance<void>(
      {url: `/v1/bookmarks/reorder`, method: 'PATCH',
      headers: {'Content-Type': 'application/json', },
      data: reorderBookmarksDto, signal
    },
      options);
    }
...
export const getBookmarksControllerReorderMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof bookmarksControllerReorder>>, TError,{data: ReorderBookmarksDto}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof bookmarksControllerReorder>>, TError,{data: ReorderBookmarksDto}, TContext> => {

const mutationKey = ['bookmarksControllerReorder'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof bookmarksControllerReorder>>, {data: ReorderBookmarksDto}> = (props) => {
          const {data} = props ?? {};

          return  bookmarksControllerReorder(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type BookmarksControllerReorderMutationResult = NonNullable<Awaited<ReturnType<typeof bookmarksControllerReorder>>>
    export type BookmarksControllerReorderMutationBody = ReorderBookmarksDto
    export type BookmarksControllerReorderMutationError = unknown

    /**
 * @summary Reorder bookmarks position
 */
export const useBookmarksControllerReorder = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof bookmarksControllerReorder>>, TError,{data: ReorderBookmarksDto}, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof bookmarksControllerReorder>>,
        TError,
        {data: ReorderBookmarksDto},
        TContext
      > => {
      return useMutation(getBookmarksControllerReorderMutationOptions(options), queryClient);
    }
    /**
